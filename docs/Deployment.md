...
## 6. On-Call / Runbook — docs/RUNBOOK.md
...
|---|---|
| TechSpec.md | Environments matrix |
| API.md | Probe endpoints |
| SecurityAndCompliance.md | Incident response |
| ImplementationPlan.md | TASK-3.x |
