...
**Goal:** One unambiguous codebase. **Exit:** INVENTORY.md with 0 AMBIGUOUS entries.

| TASK | Description | Depends | Owner | Effort | Maps to |
|---|---|---|---|---|---|
| TASK-0.1 | Forensic inventory (import-graph) | — | Owner | 3d | INVENTORY.md |
...
- [ ] Docs updated (Schema.md/API.md/SecurityAndCompliance.md as applicable)
...
|---|---|
| PRD.md | REQ IDs traced |
| AppFlow.md | SCR IDs traced |
| Schema.md | TBL IDs traced |
| Tracker.md | Live status incl. Phase 4 |
