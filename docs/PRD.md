...
|---|---|---|
| North star: demonstration value | 8.1/10 audit (from 3.8) | SELF_AUDIT.md |
...
- Known gap: `pybreaker` dependency missing from local env (see Tracker.md blocker) — documented, fixes tests/test_integration.py import.

## 10. Risks

Top risks from RiskRegister.md:
...
|---|---|
| TechSpec.md | Architecture & stack |
| AppFlow.md | Screens/journeys |
| Design.md | React SPA design system |
| Schema.md | Data model |
| ImplementationPlan.md | Phase plan |
| Tracker.md | Live status incl. pybreaker blocker |
| Rules.md | Standards & CI gates |
| API.md | v1/v2 endpoint contracts |
| SecurityAndCompliance.md | Threat model, 2FA, CSRF detail |
| Testing.md | 386-test strategy |
| Deployment.md | Docker/K8s/Grafana |
| Glossary.md | Vocabulary |
| RiskRegister.md | Full register |
