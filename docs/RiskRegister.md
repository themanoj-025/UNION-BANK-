...
| R-10 | Dead code re-accumulation | Medium | Low | 3 | INVENTORY.md discipline + ADR-0001 | Owner | Open |
...
|---|---|
| PRD.md | Top risk summary |
| SecurityAndCompliance.md | Security risks |
| Tracker.md | R-01 blocker status |
