...
|---|---|
| PRD.md | Requirements implemented |
| Schema.md | Tables behind repositories |
| API.md | v1/v2 contracts |
| SecurityAndCompliance.md | Security architecture detail |
| Deployment.md | Docker/K8s topology |
