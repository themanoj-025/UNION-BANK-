...
def init_db():
    ...
    from .persistence import AccountModel, AdminModel, AuditLogModel, LoanModel, LoginAttemptModel, NotificationModel, NotificationPreferenceModel, RefreshTokenModel, SavingsGoalModel, TokenVersionModel, TransactionModel  # noqa: F401
    engine = get_engine()
